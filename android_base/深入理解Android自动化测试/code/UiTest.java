...
public class UiTest extends TestCase {
    ...
    public void testA() throws UiObjectNotFoundException {
        ...
        // 启动测试App
        Intent intent = context.getPackageManager().getLaunchIntentForPackage("com.xuben.hellobugben");
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        context.startActivity(intent);

        // 打开CollapsingToolbarLayout
        String resourceId = "com.xuben.hellobugben:id/big";
        ...
        // 点击应用返回按钮
        UiObject back = uiDevice.findObject(new UiSelector().description("Bold"));
        back.click();

        UiObject about = uiDevice.findObject(new UiSelector().description("Submit"));
        about.click();
    }
    ...
    public void testB() throws UiObjectNotFoundException {
        ...
        // 点击Settings按钮
        UiObject uiObject = uiDevice.findObject(new UiSelector().description("Bold"));
        uiObject.click();
